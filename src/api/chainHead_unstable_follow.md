...
- `transactionVersion`: Opaque integer. Necessary when building the bytes of an transaction. Transactions that have been generated with a different `transactionVersion` are incompatible.
