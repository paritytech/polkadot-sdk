...
pub use polkadot_runtime_parachains::inclusion::{Config as InclusionConfig, UmpQueueId};
	...
	(
		...
		$(
			...
			impl<N: $crate::Network> $crate::Parachain for $name<N> {
				...
				fn new_block() {
					use $crate::{
						Dispatchable, Chain, Convert, TestExt, Zero, TimestampConfig, AdditionalInherentCode
					};
