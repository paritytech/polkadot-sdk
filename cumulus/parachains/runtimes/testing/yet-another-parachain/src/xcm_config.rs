...
use xcm_builder::{
	...
	FrameTransactionalProcessor, FungibleAdapter, IsConcrete, NativeAsset, RelayChainAsNative,
...
pub type LocationToAccountId =
	parachains_common::xcm_config::LocalAndSiblingLocationToAccountId<RelayNetwork, AccountId>;
