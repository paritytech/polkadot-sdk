...
pub use frame_support::{
	...
	parameter_types,
	traits::{
		AsEnsureOriginWithArg, ConstBool, ConstU32, ConstU64, ConstU8, Contains, Disabled,
		EitherOfDiverse, Everything, IsInVec, Nothing, Randomness,
	},
	weights::{
		constants::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: Cow::Borrowed("test-parachain"),
	impl_name: Cow::Borrowed("test-parachain"),
	authoring_version: 1,
...
pub const MILLIWND: Balance = 1_000_000_000;
pub const MICROWND: Balance = 1_000_000;
...
parameter_types! {
	pub const ExistentialDeposit: u128 = MILLIWND;
	pub const TransferFee: u128 = MILLIWND;
	pub const CreationFee: u128 = MILLIWND;
	pub const TransactionByteFee: u128 = MICROWND;
}
...
parameter_types! {
	...
	// One WND buys 1 second of weight.
	pub const WeightPrice: (Location, u128) = (Location::parent(), WND);
...
impl xcm_executor::Config for XcmConfig {
	...
	type Trader = UsingComponents<IdentityFee<Balance>, WndLocation, AccountId, Balances, ()>;
...
parameter_types! {
	pub const AssetDeposit: Balance = WND;
	pub const AssetAccountDeposit: Balance = WND;
	pub const ApprovalDeposit: Balance = 100 * MILLIWND;
	pub const AssetsStringLimit: u32 = 50;
	pub const MetadataDepositBase: Balance = WND;
	pub const MetadataDepositPerByte: Balance = 10 * MILLIWND;
	pub const UnitBody: BodyId = BodyId::Unit;
}

/// A majority of the Unit body from Westend over XCM is our required administration origin.
pub type AdminOrigin =
	EitherOfDiverse<EnsureRoot<AccountId>, EnsureXcm<IsMajorityOfBody<WndLocation, UnitBody>>>;
