...
use xcm_builder::{
	...
	FungibleAdapter, HashedDescription, IsConcrete, NonFungibleAdapter, ParentAsSuperuser,
...
parameter_types! {
	...
	// Test [`treasury_pallet_account_not_none`] ensures that the result of location
