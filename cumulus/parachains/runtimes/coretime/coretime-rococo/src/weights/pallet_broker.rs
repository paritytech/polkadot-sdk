...
// --output=./cumulus/parachains/runtimes/coretime/coretime-rococo/src/weights/pallet_broker.rs
...
impl<T: frame_system::Config> pallet_broker::WeightInfo for WeightInfo<T> {
	...
	fn start_sales(_n: u32, ) -> Weight {
		...
		Weight::from_parts(56_738_055, 0)
	...
	fn claim_revenue(m: u32, ) -> Weight {
		...
		Weight::from_parts(64_601_933, 0)
			.saturating_add(Weight::from_parts(0, 6196))
			// Standard Error: 114_459
			.saturating_add(Weight::from_parts(1_784_254, 0).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(3))
	...
	fn request_core_count(n: u32, ) -> Weight {
		...
		Weight::from_parts(21_600_464, 0)
	...
	fn rotate_sale(_n: u32, ) -> Weight {
		...
		//  Estimated: `8499`
		// Minimum execution time: 43_000_000 picoseconds.
		Weight::from_parts(45_171_081, 0)
			.saturating_add(Weight::from_parts(0, 8499))
			.saturating_add(T::DbWeight::get().reads(5))
