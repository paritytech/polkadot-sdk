...
//! EXECUTION: Some(Wasm), WASM-EXECUTION: Compiled, CHAIN: Some("coretime-kusama-dev"), DB CACHE: 1024
...
// --output=./cumulus/parachains/runtimes/coretime/coretime-kusama/src/weights/pallet_multisig.rs
