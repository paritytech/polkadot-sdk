...
use parachains_common::{
	impls::ToStakingPot, polkadot::currency::CENTS, xcm_config::ConcreteNativeAssetFrom,
};
...
impl xcm_executor::Config for XcmConfig {
	...
	// Coretime does not recognize a reserve location for any asset. Users must teleport DOT
