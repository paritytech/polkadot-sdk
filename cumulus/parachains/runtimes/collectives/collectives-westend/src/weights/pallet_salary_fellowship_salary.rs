...
impl<T: frame_system::Config> pallet_salary::WeightInfo for WeightInfo<T> {
	...
	fn payout() -> Weight {
		...
		//  Measured:  `671`
		//  Estimated: `4136`
		// Minimum execution time: 64_628_000 picoseconds.
	...
	fn payout_other() -> Weight {
		...
		//  Measured:  `671`
		//  Estimated: `4136`
		// Minimum execution time: 65_257_000 picoseconds.
		Weight::from_parts(68_627_000, 0)
			.saturating_add(Weight::from_parts(0, 4136))
			.saturating_add(T::DbWeight::get().reads(9))
			.saturating_add(T::DbWeight::get().writes(6))
	}
	...
	fn check_payment() -> Weight {
		...
		Weight::from_parts(28_572_000, 0)
