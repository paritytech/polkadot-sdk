...
impl<T: frame_system::Config> polkadot_runtime_common::identity_migrator::WeightInfo for WeightInfo<T> {
	...
	fn reap_identity(_r: u32, s: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `673 + r * (5 ±0) + s * (32 ±0)`
		//  Estimated: `6723`
		// Minimum execution time: 34_555_000 picoseconds.
		Weight::from_parts(39_684_457, 0)
			.saturating_add(Weight::from_parts(0, 6723))
			// Standard Error: 4_597
			.saturating_add(Weight::from_parts(1_399_226, 0).saturating_mul(s.into()))
	...
	fn poke_deposit() -> Weight {
		...
		Weight::from_parts(47_923_000, 0)
			.saturating_add(Weight::from_parts(0, 6723))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
