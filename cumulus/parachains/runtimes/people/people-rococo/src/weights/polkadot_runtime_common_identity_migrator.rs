...
impl<T: frame_system::Config> polkadot_runtime_common::identity_migrator::WeightInfo for WeightInfo<T> {
	...
	fn reap_identity(r: u32, s: u32, ) -> Weight {
		...
		Weight::from_parts(38_000_775, 0)
			.saturating_add(Weight::from_parts(0, 6723))
			// Standard Error: 12_718
			.saturating_add(Weight::from_parts(74_871, 0).saturating_mul(r.into()))
			// Standard Error: 2_605
			.saturating_add(Weight::from_parts(1_398_867, 0).saturating_mul(s.into()))
	...
	fn poke_deposit() -> Weight {
		...
		//  Measured:  `705`
		//  Estimated: `6723`
		// Minimum execution time: 49_269_000 picoseconds.
		Weight::from_parts(50_215_000, 0)
			.saturating_add(Weight::from_parts(0, 6723))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
