...
pub mod account {
	...
	/// Secretary Referenda pallet ID - uused as a temporary place to deposit a slashed imbalance
	/// before the teleport to the Treasury.
	pub const SECRETARY_REFERENDA_PALLET_ID: PalletId = PalletId(*b"pysecref");
