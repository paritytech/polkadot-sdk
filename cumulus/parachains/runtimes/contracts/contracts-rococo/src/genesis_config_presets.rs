...
//! # Contracts Rococo Runtime genesis config presets
...
const CONTRACTS_ROCOCO_ED: Balance = ExistentialDeposit::get();
...
pub fn get_preset(id: &PresetId) -> Option<Vec<u8>> {
	let patch = match id.as_ref() {
		sp_genesis_builder::LOCAL_TESTNET_RUNTIME_PRESET => contracts_rococo_genesis(
			// initial collators.
			vec![
		...
		sp_genesis_builder::DEV_RUNTIME_PRESET => contracts_rococo_genesis(
			// initial collators.
