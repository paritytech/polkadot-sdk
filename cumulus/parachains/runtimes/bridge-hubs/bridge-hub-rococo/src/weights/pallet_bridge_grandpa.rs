...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn submit_finality_proof(p: u32, _v: u32, ) -> Weight {
		...
		//  Measured:  `438 + p * (60 ±0)`
		//  Estimated: `51735`
		// Minimum execution time: 301_982_000 picoseconds.
		Weight::from_parts(356_093_000, 0)
			.saturating_add(Weight::from_parts(0, 51735))
			// Standard Error: 24_378
			.saturating_add(Weight::from_parts(50_293_143, 0).saturating_mul(p.into()))
	...
	fn force_set_pallet_state() -> Weight {
		...
		//  Measured:  `452`
		//  Estimated: `51735`
		// Minimum execution time: 116_939_000 picoseconds.
		Weight::from_parts(133_108_000, 0)
			.saturating_add(Weight::from_parts(0, 51735))
