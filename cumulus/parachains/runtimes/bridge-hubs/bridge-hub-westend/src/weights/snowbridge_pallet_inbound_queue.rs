...
impl<T: frame_system::Config> snowbridge_pallet_inbound_queue::WeightInfo for WeightInfo<T> {
	...
	fn submit(n: u32, s: u32, ) -> Weight {
		...
		Weight::from_parts(223_408_329, 0)
			.saturating_add(Weight::from_parts(0, 4150))
			// Standard Error: 58_574
			.saturating_add(Weight::from_parts(2_201_191, 0).saturating_mul(n.into()))
			// Standard Error: 234
			.saturating_add(Weight::from_parts(10_965, 0).saturating_mul(s.into()))
