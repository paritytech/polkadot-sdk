...
//! HOSTNAME: `ef7d9fa8272a`, CPU: `Intel(R) Xeon(R) CPU @ 2.60GHz`
...
impl<T: frame_system::Config> snowbridge_pallet_outbound_queue_v2::WeightInfo for WeightInfo<T> {
	...
	fn process() -> Weight {
		...
		//  Measured:  `75`
		//  Estimated: `1493`
		// Minimum execution time: 612_295_000 picoseconds.
		Weight::from_parts(634_316_000, 0)
			.saturating_add(Weight::from_parts(0, 1493))
			.saturating_add(T::DbWeight::get().reads(1))
	...
	fn submit_delivery_receipt() -> Weight {
		...
		Weight::from_parts(101_585_000, 0)
