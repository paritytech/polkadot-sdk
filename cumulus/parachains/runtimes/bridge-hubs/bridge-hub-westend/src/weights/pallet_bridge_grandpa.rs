...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn submit_finality_proof(p: u32, _v: u32, ) -> Weight {
		...
		//  Measured:  `31 + p * (60 ±0)`
		//  Estimated: `51735`
		// Minimum execution time: 314_708_000 picoseconds.
		Weight::from_parts(322_274_000, 0)
			.saturating_add(Weight::from_parts(0, 51735))
			// Standard Error: 36_687
			.saturating_add(Weight::from_parts(45_277_175, 0).saturating_mul(p.into()))
	...
	fn force_set_pallet_state() -> Weight {
		...
		//  Measured:  `84`
		//  Estimated: `51735`
		// Minimum execution time: 73_044_000 picoseconds.
		Weight::from_parts(76_732_000, 0)
			.saturating_add(Weight::from_parts(0, 51735))
