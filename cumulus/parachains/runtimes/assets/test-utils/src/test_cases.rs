	...
	ForeignAssetsPalletInstance: 'static,
{
	...
	ExtBuilder::<Runtime>::default()
		...
		.execute_with(|| {
			...
			let native_issuance_before = pallet_balances::Pallet::total_issuance();
			...
			let foreign_issuance_after = pallet_assets::Pallet::<Runtime, ForeignAssetsPalletInstance>::total_issuance(asset_location);
			let native_issuance_after = pallet_balances::Pallet::total_issuance();
			assert_eq!(
