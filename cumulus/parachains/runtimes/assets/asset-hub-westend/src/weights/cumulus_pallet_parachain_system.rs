...
impl<T: frame_system::Config> cumulus_pallet_parachain_system::WeightInfo for WeightInfo<T> {
	...
	fn enqueue_inbound_downward_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(177_114_531, 0)
			.saturating_add(Weight::from_parts(0, 3517))
			// Standard Error: 94_491
			.saturating_add(Weight::from_parts(255_697_332, 0).saturating_mul(n.into()))
	...
	fn block_weight_tx_extension_stays_fraction_of_core() -> Weight {
		...
		Weight::from_parts(10_306_000, 0)
			.saturating_add(Weight::from_parts(0, 0))
	}
