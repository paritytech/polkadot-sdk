...
// --pallet=assets_common_migrations
...
/// Weight functions for `assets_common_migrations`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> assets_common_migrations::WeightInfo for WeightInfo<T> {
