...
impl<T: frame_system::Config> pallet_staking_async::WeightInfo for WeightInfo<T> {
	...
	fn prune_era(v: u32, ) -> Weight {
		...
		//  Estimated: `1633077 + v * (3937 ±67)`
		// Minimum execution time: 529_741_000 picoseconds.
		Weight::from_parts(334_355_257, 0)
			.saturating_add(Weight::from_parts(0, 1633077))
			// Standard Error: 26_708
			.saturating_add(Weight::from_parts(5_323_653, 0).saturating_mul(v.into()))
