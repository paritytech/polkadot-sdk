...
impl pallet_xcm_bridge_hub_router::Config<ToWestendOverBridgeHubLegacyXcmRouterInstance>
	for Runtime
{
	type RuntimeEvent = RuntimeEvent;
	type WeightInfo =
		weights::pallet_xcm_bridge_hub_router_to_westend_over_bridge_hub::WeightInfo<Runtime>;
