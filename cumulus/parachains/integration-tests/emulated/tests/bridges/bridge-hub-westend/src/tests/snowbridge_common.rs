...
pub fn create_pools_on_ah() {
	...
	create_pool_with_native_on!(AssetHubWestend, weth_location(), true, ethereum_sovereign.clone(), 1_000_000_000_000, 20_000_000_000);
	create_pool_with_native_on!(AssetHubWestend, ethereum(), true, ethereum_sovereign.clone(), 1_000_000_000_000, 20_000_000_000);
}
