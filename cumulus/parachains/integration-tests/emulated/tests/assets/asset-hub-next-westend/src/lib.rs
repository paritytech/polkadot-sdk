...
mod imports {
	...
	pub use westend_system_emulated_network::{
		asset_hub_next_westend_emulated_chain::{
			asset_hub_next_westend_runtime::{
				self,
				xcm_config::{
					self as ahw_xcm_config, WestendLocation as RelayLocation,
					XcmConfig as AssetHubNextWestendXcmConfig,
				},
				AssetConversionOrigin as AssetHubNextWestendAssetConversionOrigin,
				ExistentialDeposit as AssetHubNextWestendExistentialDeposit,
			},
			genesis::{AssetHubNextWestendAssetOwner, ED as ASSET_HUB_NEXT_WESTEND_ED},
			AssetHubNextWestendParaPallet as AssetHubNextWestendPallet,
		},
		...
		AssetHubNextWestendPara as AssetHubNextWestend,
		AssetHubNextWestendParaReceiver as AssetHubNextWestendReceiver,
		AssetHubNextWestendParaSender as AssetHubNextWestendSender,
	...
	pub type SystemParaToRelayTest = Test<AssetHubNextWestend, Westend>;
	pub type SystemParaToParaTest = Test<AssetHubNextWestend, PenpalA>;
	pub type ParaToSystemParaTest = Test<PenpalA, AssetHubNextWestend>;
	pub type ParaToParaThroughRelayTest = Test<PenpalA, PenpalB, Westend>;
	pub type ParaToParaThroughAHTest = Test<PenpalA, PenpalB, AssetHubNextWestend>;
	pub type RelayToParaThroughAHTest = Test<Westend, PenpalA, AssetHubNextWestend>;
	pub type PenpalToRelayThroughAHTest = Test<PenpalA, Westend, AssetHubNextWestend>;
}
