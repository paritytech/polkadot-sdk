...
fn send_transact_as_superuser_from_relay_to_asset_hub_works() {
	AssetHubNextWestend::force_create_asset_from_relay_as_root(
		ASSET_ID,
		ASSET_MIN_BALANCE,
		true,
...
fn send_xcm_from_para_to_asset_hub_paying_fee_with_system_asset() {
	let para_sovereign_account = AssetHubNextWestend::sovereign_account_id_of(
	...
	let call = AssetHubNextWestend::create_foreign_asset_call(
	...
	let fee_amount = ASSET_HUB_NEXT_WESTEND_ED * 1000000;
	...
	AssetHubNextWestend::fund_accounts(vec![(
		...
		ASSET_HUB_NEXT_WESTEND_ED * 10000000000,
	)]);
...
fn send_xcm_from_para_to_asset_hub_paying_fee_with_sufficient_asset() {
	...
	AssetHubNextWestend::force_create_and_mint_asset(
		ASSET_ID,
		ASSET_MIN_BALANCE,
		true,
		para_sovereign_account.clone(),
	...
	// Encoded `create_asset` call to be executed in AssetHub
	let call = AssetHubNextWestend::create_asset_call(
		new_asset_id,
		ASSET_MIN_BALANCE,
		para_sovereign_account.clone(),
	);
