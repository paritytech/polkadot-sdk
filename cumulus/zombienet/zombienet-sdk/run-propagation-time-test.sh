...
ZOMBIE_PROVIDER=native cargo test --release -p cumulus-zombienet-sdk-tests --features zombie-ci --features zombie-metadata -- --ignored sparsely_connected_network_block_propagation_time
