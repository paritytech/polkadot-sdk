...
impl SubstrateCli for TestCollatorCli {
	...
	fn load_spec(&self, id: &str) -> std::result::Result<Box<dyn sc_service::ChainSpec>, String> {
		Ok(Box::new(match id {
			...
			"relay-parent-offset-2" => cumulus_test_service::get_chain_spec(
				cumulus_test_runtime::relay_parent_offset_2::WASM_BINARY,
			...
			"elastic-scaling-v3-rpo-1" => {
				tracing::info!("Using elastic scaling V3 with relay parent offset 1 chain spec.");
				cumulus_test_service::get_chain_spec(
					cumulus_test_runtime::elastic_scaling_v3_rpo_1::WASM_BINARY,
					Some(ParaId::from(2900)),
				)
			},
