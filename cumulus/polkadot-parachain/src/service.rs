...
use crate::{
	...
	rpc::{BuildEmptyRpcExtensions, BuildParachainRpcExtensions, BuildRpcExtensions},
};
...
pub(crate) trait NodeSpec {
	...
	fn new_partial(
		config: &Configuration,
	) -> sc_service::error::Result<Service<Self::Block, Self::RuntimeApi>> {
