...
//!
//! The parent search yields them as bare headers. [`hydrate_segment`] rebuilds
...
/// Why a single resubmittable header could not be hydrated into a [`CollatorSegmentEntry`].
///
...
/// Hydrate a list of resubmittable headers (oldest first) into [`CollatorSegmentEntry`]s.
///
