...
use cumulus_primitives_core::{KeyToIncludeInRelayProof, RelayParentOffsetApi, SchedulingProof, SchedulingV3EnabledApi};
...
pub fn run<Block, P, BI, CIDP, Client, Backend, RClient, CHP, Proposer, CS, Spawner>(
	...
	Client: ProvideRuntimeApi<Block>
		...
		+ 'static,
	Client::Api:
		AuraApi<Block, P::Public> + AuraUnincludedSegmentApi<Block> + RelayParentOffsetApi<Block> + KeyToIncludeInRelayProof<Block> + SchedulingV3EnabledApi<Block>,
