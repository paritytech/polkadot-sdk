...
pub type ParachainHostFunctions = (
	...
	sp_statement_store::runtime_api::HostFunctions, // TODO TODO: where is the extension registered?
													// register a default no-op one or the good one
													// depending on the presenve of
													// `ValidateStatement`.
