...
pub enum Subcommand {
    ...
    /// This command has a terrible name and we only keep it because some existing tools and scripts expect it.
    /// You should use --export-genesis-head instead whenever possible.
    #[clap(hide = true)]
