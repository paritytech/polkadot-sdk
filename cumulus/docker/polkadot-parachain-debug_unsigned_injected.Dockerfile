...
LABEL io.parity.image.authors="devops-team@parity.io" \
	...
	io.parity.image.source="https://github.com/paritytech/cumulus/blob/${VCS_REF}/docker/polkadot-parachain/polkadot-parachain-debug_unsigned_injected.Dockerfile" \
