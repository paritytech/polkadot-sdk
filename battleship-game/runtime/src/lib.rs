...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: alloc::borrow::Cow::Borrowed("battleship-runtime"),
	impl_name: alloc::borrow::Cow::Borrowed("battleship-runtime"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 0,
...
pub(crate) const TARGET_BLOCK_RATE: u32 = 12;
...
mod runtime {
	...
	pub type Battleship = pallet_battleship;
