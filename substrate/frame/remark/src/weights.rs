...
// --output=/__w/polkadot-sdk/polkadot-sdk/substrate/frame/remark/src/weights.rs
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn store(l: u32, ) -> Weight {
		...
		Weight::from_parts(13_971_525, 0)
			// Standard Error: 0
			.saturating_add(Weight::from_parts(1_678, 0).saturating_mul(l.into()))
	}
}
