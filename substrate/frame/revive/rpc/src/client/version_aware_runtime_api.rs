...
impl VersionAwareRuntimeApi {
	...
	///
	/// `transactions` is the list the header commits to. A block with mirrored logs ends with a
	/// synthetic transaction, whose receipt entry only version 2 of [`Self::eth_receipt_data`]
	/// reports.
