...
impl Client {
	...
	pub fn create_block_notifier(&mut self, capacity: Option<usize>) {
		self.block_notifier = Some(tokio::sync::broadcast::channel::<H256>(capacity.unwrap_or(NOTIFIER_CAPACITY)).0);
	}
