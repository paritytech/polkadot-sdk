...
mod tests {
	use super::*;
	use pallet_revive_types::{common::Bytes, storage as revive_storage_types};

	fn assert_encodes_like_pristine_code_wrapper<T>()
	where
		T: EncodeLike<StorageCodecWrapper<Vec<u8>, revive_storage_types::PristineCodeV1>>,
	{
	}
