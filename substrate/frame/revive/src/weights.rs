...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// The range of component `n` is `[0, 416]`.
	///
	/// Placeholder weight for the unstable `UnstableRuntime::getStorage` precompile;
	/// to be regenerated by `/cmd bench`.
	fn unstable_runtime_get_storage(n: u32, ) -> Weight {
		Weight::from_parts(9_488_678, 247)
			.saturating_add(Weight::from_parts(1_187, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	/// Fixed overhead of the unstable `UnstableRuntime::dispatch` wrapper;
	/// to be regenerated by `/cmd bench`.
	fn unstable_runtime_dispatch() -> Weight {
