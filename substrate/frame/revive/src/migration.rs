...
//! Multi-block Migration framework for pallet-revive.
//!
...
//! ## Example:
//!
//! To configure a migration to `v11` for a runtime using `v10` of pallet-revive on the chain,
...
pub trait MigrateSequence: private::Sealed {
	...
	///
	/// ```compile_fail
	///     # use pallet_revive::{NoopMigration, MigrateSequence};
