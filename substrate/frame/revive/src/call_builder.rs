...
use crate::{
	...
	GasMeter, MomentOf, Origin, Pallet as Contracts, PristineCode, VmBlob, Weight,
};
...
type StackExt<'a, T> = Stack<'a, T, VmBlob<T>>;
	...
	T::Hash: frame_support::traits::IsType<H256>,
{
	...
	pub fn new(module: VmModule) -> Self {
	...
	pub fn ext(&mut self) -> (StackExt<'_, T>, VmBlob<T>) {
	...
	T::Hash: frame_support::traits::IsType<H256>,
{
	...
	pub fn new(module: VmModule, data: Vec<u8>) -> Result<Contract<T>, &'static str> {
...
/// A vm module ready to be put on chain.
#[derive(Clone)]
pub struct VmModule {
	pub code: Vec<u8>,
	pub hash: H256,
