...
define_versioned_type! {
	...
	pub struct DebugSettingsV1 {
		...
		/// Whether EIP-3607 sender checks are bypassed.
		pub bypass_eip_3607: bool,
		/// Whether PolkaVM logs are emitted.
		pub pvm_logs: bool,
		/// Whether execution tracing is disabled.
		pub disable_execution_tracing: bool,
	}
}
