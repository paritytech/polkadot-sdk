...
//! deposit is said to be **Ejected**. Ejected solutions get [`signed::Config::EjectGraceRatio`] of their
...
//!    discarded. But, to delete their data, they have to call [`signed::Call::clear_old_round_data`]. Once
