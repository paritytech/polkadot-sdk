...
<<<<<<< HEAD:substrate/frame/assets/src/precompiles.rs
...
=======
>>>>>>> cfce3b9 (`pallet-assets`: extract precompiles to a separate crate (#9796)):substrate/frame/assets/precompiles/src/lib.rs
