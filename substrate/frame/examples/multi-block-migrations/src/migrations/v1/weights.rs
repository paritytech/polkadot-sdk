...
//! Autogenerated weights for `pallet_example_pallet_mbm`
//!
...
/// Weight functions needed for `pallet_example_pallet_mbm`.
pub trait WeightInfo {
	fn step() -> Weight;
}

/// Weights for `pallet_example_pallet_mbm` using the Substrate node and recommended hardware.
