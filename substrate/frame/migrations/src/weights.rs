...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn onboard_new_mbms() -> Weight {
		...
		Weight::from_parts(4_756_000, 67035)
	...
	fn progress_mbms_none() -> Weight {
		...
		Weight::from_parts(788_000, 67035)
	...
	fn exec_migration_completed() -> Weight {
		...
		Weight::from_parts(4_228_000, 3465)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_skipped_historic() -> Weight {
		...
		Weight::from_parts(7_814_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	/// Proof: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_advance() -> Weight {
		...
		Weight::from_parts(7_246_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	/// Proof: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_fail() -> Weight {
		...
		Weight::from_parts(9_325_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	fn on_init_loop() -> Weight {
	...
	fn force_onboard_mbms() -> Weight {
		...
		Weight::from_parts(3_124_000, 67035)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		Weight::from_parts(11_903_113, 3834)
			// Standard Error: 3_256
			.saturating_add(Weight::from_parts(1_452_040, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn reset_pallet_migration(n: u32, ) -> Weight {
		...
		Weight::from_parts(4_168_916, 686)
			// Standard Error: 1_502
			.saturating_add(Weight::from_parts(831_223, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
