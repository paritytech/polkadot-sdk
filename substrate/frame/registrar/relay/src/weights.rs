...
pub trait WeightInfo {
	...
	fn on_new_head_already_noted() -> Weight;
	fn receive_deregister() -> Weight;
}
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Storage: `RegistrarRelay::AwaitingFirstHead` (r:0 w:1)
	/// Proof: `RegistrarRelay::AwaitingFirstHead` (`max_values`: None, `max_size`: Some(20), added: 2495, mode: `MaxEncodedLen`)
	...
	fn receive_register(h: u32, ) -> Weight {
		...
		Weight::from_parts(13_912_216, 1052141)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(347, 0).saturating_mul(h.into()))
	...
	fn apply_authorized_code(c: u32, ) -> Weight {
		...
		Weight::from_parts(266_557_186, 1052141)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(837, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn authorize_apply_authorized_code(c: u32, ) -> Weight {
		...
		Weight::from_parts(266_590_631, 1052141)
			// Standard Error: 0
			.saturating_add(Weight::from_parts(645, 0).saturating_mul(c.into()))
	...
	fn receive_cancel_registration() -> Weight {
		...
		Weight::from_parts(10_000_000, 1052141)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `RegistrarRelay::AwaitingFirstHead` (r:1 w:1)
	/// Proof: `RegistrarRelay::AwaitingFirstHead` (`max_values`: None, `max_size`: Some(20), added: 2495, mode: `MaxEncodedLen`)
	fn on_new_head() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `24`
		...
		Weight::from_parts(4_000_000, 3485)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `RegistrarRelay::AwaitingFirstHead` (r:1 w:0)
	/// Proof: `RegistrarRelay::AwaitingFirstHead` (`max_values`: None, `max_size`: Some(20), added: 2495, mode: `MaxEncodedLen`)
	fn on_new_head_already_noted() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		...
		Weight::from_parts(1_000_000, 3485)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `RegistrarRelay::AwaitingFirstHead` (r:0 w:1)
	/// Proof: `RegistrarRelay::AwaitingFirstHead` (`max_values`: None, `max_size`: Some(20), added: 2495, mode: `MaxEncodedLen`)
