...
// effect /// on price. If there are no cores left for sale on the open markent, renewals will
// affect price /// even in the interlude, making sure renewal prices stay in the range of the open
// market. fn renewals_affect_price() {
