	...
	quote! {
		...
		impl InherentDataExt for #scrate::inherent::InherentData {
				...
				#scrate::inherent::CheckInherentsResult
			{
				...
				use #scrate::sp_runtime::traits::{Block as _, LazyExtrinsic};
				...
				for xt in block.extrinsics_mut() {
					...
					let call = LazyExtrinsic::try_get_or_decode_call(xt)
		...
		impl #scrate::traits::IsInherent<<#block as #scrate::sp_runtime::traits::Block>::Extrinsic> for #runtime {
			fn is_inherent(
				ext: &<<#block as #scrate::sp_runtime::traits::Block>::Extrinsic as #scrate::sp_runtime::traits::LazyExtrinsic>::FullExtrinsicRef
			) -> bool {
