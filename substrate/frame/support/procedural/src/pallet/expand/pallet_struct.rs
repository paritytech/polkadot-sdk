...
pub fn expand_pallet_struct(def: &mut Def) -> proc_macro2::TokenStream {
	...
	let storage_info = quote::quote_spanned!(storage_info_span =>
		...
		{
			fn storage_info()
				-> #frame_support::__private::alloc::vec::Vec<#frame_support::traits::StorageInfo>
			{
				#[allow(unused_mut)]
				let mut res = #frame_support::__private::alloc::vec![];
	...
	let whitelisted_storage_keys_impl = quote::quote![
		...
		impl<#type_impl_gen> WhitelistedStorageKeys for #pallet_ident<#type_use_gen> #storages_where_clauses {
			fn whitelisted_storage_keys() -> #frame_support::__private::alloc::vec::Vec<TrackedStorageKey> {
				use #frame_support::__private::alloc::vec;
				vec![#(
	...
	quote::quote_spanned!(def.pallet_struct.attr_span =>
		...
		{
			fn count() -> usize { 1 }
			fn infos() -> #frame_support::__private::alloc::vec::Vec<#frame_support::traits::PalletInfoData> {
				...
				#frame_support::__private::alloc::vec![item]
			}
		}
