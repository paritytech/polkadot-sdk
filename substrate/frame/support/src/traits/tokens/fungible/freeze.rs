...
pub trait VestingSchedule<AccountId> {
	...
	type Fungible: super::Inspect<AccountId>;
	...
	fn add_vesting_schedule(
		who: &AccountId,
		locked: <Self::Fungible as super::Inspect<AccountId>>::Balance,
		per_block: <Self::Fungible as super::Inspect<AccountId>>::Balance,
