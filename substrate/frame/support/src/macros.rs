...
macro_rules! assert_noop {
	(
		...
		let h = $crate::__private::storage_fingerprint();
		$crate::assert_err!($x, $y);
		assert_eq!(h, $crate::__private::storage_fingerprint(), "storage has been mutated");
	};
}
...
macro_rules! assert_storage_noop {
	(
		...
		let h = $crate::__private::storage_fingerprint();
		$x;
		assert_eq!(h, $crate::__private::storage_fingerprint());
	};
}
