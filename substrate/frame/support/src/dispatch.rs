...
use sp_runtime::{
	generic::{CheckedExtrinsic, FullUncheckedExtrinsicRef},
	traits::{
...
impl<'a, Address, Call: Dispatchable, Signature, Extension: TransactionExtension<Call>>
	GetDispatchInfo for FullUncheckedExtrinsicRef<'a, Address, Call, Signature, Extension>
where
...
mod extension_weight_tests {
	...
	fn no_post_dispatch_with_no_refund() {
		ExtBuilder::default().build_and_execute(|| {
			...
			assert_eq!(uxt.expect_as_full().extension_weight(), Weight::from_parts(600, 0));
