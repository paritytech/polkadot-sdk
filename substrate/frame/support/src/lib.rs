...
pub mod pallet_macros {
	...
	/// anything else, you need to meet a number of trait bound constraints. See: <https://paritytech.github.io/polkadot-sdk/master/polkadot_sdk_docs/reference_docs/frame_storage_derives/index.html>. Notably, all value types need to implement `Encode`, `Decode`, `MaxEncodedLen` and `TypeInfo`, and possibly `Default`, if [`ValueQuery`] is used, explained in the next section.
	///
	///
	/// ### QueryKind
	///
