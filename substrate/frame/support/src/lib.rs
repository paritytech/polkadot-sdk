...
pub mod pallet_macros {
	pub use frame_support_procedural::{
		config, disable_frame_system_supertrait_check, extra_constants, generate_store, getter,
	...
	/// `#[pallet::composite_enum]`, the aforementioned traits are automatically derived for
	/// it. The inverse is also true: if there are any `#[derive]` attributes found for the
	/// enum, then no traits will automatically be derived for it.
	///
