...
echo "✅ launching ZN"
zombienet --provider native -l text spawn zn-m.toml


# ./build.sh --rc-preset [real-m / real-s / fake-s] --para-preset [real-m / real-s / fake-dot-size / fake-ksm-size / fake-development]
