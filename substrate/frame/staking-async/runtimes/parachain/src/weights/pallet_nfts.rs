...
//! EXECUTION: ``, WASM-EXECUTION: `Compiled`, CHAIN: `Some("asset-hub-next-westend-dev")`, DB CACHE: 1024
...
// --output=./parachains/runtimes/assets/asset-hub-next-westend/src/weights/
