...
///
/// Works correctly with large AccountId types (e.g., `AccountId32`) where PalletId
/// sub-account derivation has enough bytes to be unique. For small types (u64),
/// use a custom implementation with explicit account IDs.
