...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn continue_migrate() -> Weight {
		...
		Weight::from_parts(26_714_000, 3874)
	...
	fn continue_migrate_wrong_witness() -> Weight {
		...
		Weight::from_parts(4_879_000, 1493)
	...
	fn migrate_custom_top_success() -> Weight {
		...
		Weight::from_parts(14_152_000, 3874)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn migrate_custom_top_fail() -> Weight {
		...
		Weight::from_parts(71_468_000, 3874)
	...
	fn migrate_custom_child_success() -> Weight {
		...
		Weight::from_parts(14_597_000, 3874)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Balances::Holds` (r:1 w:1)
	/// Proof: `Balances::Holds` (`max_values`: None, `max_size`: Some(409), added: 2884, mode: `MaxEncodedLen`)
	...
	fn migrate_custom_child_fail() -> Weight {
		...
		//  Measured:  `161`
		//  Estimated: `3874`
		// Minimum execution time: 72_334_000 picoseconds.
		Weight::from_parts(73_903_000, 3874)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn process_top_key(v: u32, ) -> Weight {
		...
		Weight::from_parts(5_471_000, 3657)
			// Standard Error: 18
			.saturating_add(Weight::from_parts(1_960, 0).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
