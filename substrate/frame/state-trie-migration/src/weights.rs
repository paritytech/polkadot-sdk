...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn continue_migrate() -> Weight {
		...
		Weight::from_parts(15_756_000, 3874)
	...
	fn continue_migrate_wrong_witness() -> Weight {
		...
		Weight::from_parts(2_404_000, 1493)
	...
	fn migrate_custom_top_success() -> Weight {
		...
		Weight::from_parts(11_276_000, 3874)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn migrate_custom_top_fail() -> Weight {
		...
		Weight::from_parts(64_157_000, 3874)
	...
	fn migrate_custom_child_success() -> Weight {
		...
		Weight::from_parts(11_528_000, 3874)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Balances::Holds` (r:1 w:1)
	/// Proof: `Balances::Holds` (`max_values`: None, `max_size`: Some(409), added: 2884, mode: `MaxEncodedLen`)
	...
	fn migrate_custom_child_fail() -> Weight {
		...
		//  Measured:  `41`
		//  Estimated: `3874`
		// Minimum execution time: 63_132_000 picoseconds.
		Weight::from_parts(63_921_000, 3874)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn process_top_key(v: u32, ) -> Weight {
		...
		Weight::from_parts(2_320_000, 3446)
			// Standard Error: 4
			.saturating_add(Weight::from_parts(1_477, 0).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
