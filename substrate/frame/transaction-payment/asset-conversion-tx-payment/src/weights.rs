...
/// Weight functions needed for pallet-asset-conversion-tx-payment.
...
/// Weights for pallet-asset-conversion-tx-payment using the Substrate node and recommended hardware.
