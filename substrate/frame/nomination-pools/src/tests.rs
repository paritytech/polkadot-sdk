			...
			.build_and_execute(|| {
				...
				assert_eq!(
					...
					vec![
						...
						Event::MemberRemoved { pool_id: 1, member: 40, balance: 0 },
						Event::Withdrawn { member: 550, pool_id: 1, points: 92, balance: 92 },
						Event::MemberRemoved { pool_id: 1, member: 550, balance: 0 },
						Event::PaidOut { member: 10, pool_id: 1, payout: 10 },
			...
			.build_and_execute(|| {
				...
				assert_eq!(
					...
					vec![
						...
						Event::MemberRemoved { pool_id: 1, member: 100, balance: 0 },
						Event::Withdrawn { member: 200, pool_id: 1, points: 200, balance: 200 },
						Event::MemberRemoved { pool_id: 1, member: 200, balance: 0 }
					]
				);
			});
	}
