...
use crate::{
	exec::Key,
	migration::{v09, v10, v11, v12, v13, v14, v15, ContractsMigrationStep},
	Pallet as Contracts, *,
};
...
mod benchmarks {
	...
	// This benchmarks the weight of running an empty migration that simply bump the storage
	// version.
	#[benchmark(pov_mode = Measured)]
	fn migration_version_bump() {
		use crate::migration::*;
		use frame_support::{migrations::SteppedMigration, pallet_prelude::StorageVersion};

		#[derive(Encode, Decode, MaxEncodedLen, Default)]
		struct NoopMigration;

		impl ContractsMigrationStep for NoopMigration {
		...
		#[block]
		{
			SteppedMigrationAdapter::<T, NoopMigration>::step(None, &mut WeightMeter::new())
				.unwrap();
		}

		assert_eq!(StorageVersion::get::<Pallet<T>>(), NoopMigration::VERSION);
	}
