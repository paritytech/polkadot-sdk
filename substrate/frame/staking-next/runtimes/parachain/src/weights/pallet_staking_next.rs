...
//! Autogenerated weights for `pallet_staking_next`
//!
...
/// Weight functions for `pallet_staking_next`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pallet_staking_next::WeightInfo for WeightInfo<T> {
