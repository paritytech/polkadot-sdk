...
impl ExtBuilder {
	pub fn build(self) -> sp_io::TestExternalities {
		let mut ext: sp_io::TestExternalities = RuntimeGenesisConfig {
			...
			balances: pallet_balances::GenesisConfig { balances: vec![(0, 100), (1, 98), (2, 1)], dev_accounts: (10, 100, "//Sender/{}".to_string()) },
...
fn inexistent_account_works() {
	...
	pallet_balances::GenesisConfig::<Test> { balances: vec![(0, 100), (1, 99), (2, 1)], dev_accounts: (10, 100, "//Sender/{}".to_string()) }
