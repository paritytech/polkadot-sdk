...
// 	type Public: Clone + Codec + Debug + Ord + Sync + Send + Wraps;
// 	type Signature: Clone + Codec + Debug + Clone + Sync + Send + Wraps;

// 	fn generate_in_store(store: KeystorePtr, owner: Keyring) -> Self::Public;
...
// 	fn geonerate_in_store(store: KeystorePtr, owner: Keyring) -> Self::Public {
...
// 		seed: Option<&str>,
// 	) -> Self::Public {
// 		Keystore::ecdsa_generate_new(&*store, key_type, seed)
// 			.ok()
// 			.unwrap()
// 			.into()
// 	}
...
// /// Auxiliary traits for ECDSA_BLS377
// #[cfg(feature = "bls-experimental")]
// 	impl SimpleKeyPair for ecdas_bls377_crypto::Pair {
// 		type Public = ecdas_bls377_crypto::Public;
// 		type Signature = ecdas_bls377_crypto::Signature;

// 		fn generate_in_store(store: KeystorePtr, owner: Keyring) -> Self::Public {
// 			Keystore::ecdsa_bls377_generate_new(
// 				&*store,
// 				KEY_TYPE,
// 				Some(&<Keyring as GenericKeyring<ecdsa_bls377_crypto::Pair>>::to_seed(owner)),
// 			)
// 			.ok()
// 			.unwrap()
// 			.into()
...
// 			seed: Option<&str>,
// 		) -> Self::Public {
// 			Keystore::ecdsa_bls377_generate_new(&*store, key_type, seed)
// 				.ok()
// 				.unwrap()
// 				.into()
// 		}
...
// 	    fn sign(&self, message: &[u8]) -> Self::Signature {
// 			self.sign_with_hasher::<KeccakHasher>(&message).into()
...
// 			pubkey: Self::Public,
// 		) -> bool {
// 		    ecdsa_bls377::Pair::verify_with_hasher::<KeccakHasher>(sig.as_inner_ref(), &message,
// &pubkey.as_inner_ref())

// 		}

// 		fn public(&self) -> Self::Public {
// 			<ecdsa_bls_crypto::Pair as sp_application_crypto::Pair>::public(self)
// 		}
...
// 			password_override: Option<&str>,
// 		) -> Result<Self, SecretStringError> {
// 			<ecdsa_bls_crypto::Pair as sp_application_crypto::Pair>::from_string(s, password_override)
// 		}

// 		/// Return a vec filled with raw data.
// 		fn to_raw_vec(&self) -> Vec<u8> {
// 			<ecdsa_bls_crypto::Pair as sp_application_crypto::Pair>::to_raw_vec(self)
// 		}
// 	}
