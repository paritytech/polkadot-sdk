	...
	Block::Header: Clone,
{
		...
		<Self as ProvideRuntimeApi<Block>>::Api: CoreApi<Block> + ApiExt<Block>,
	{
		...
		*self.importing_block.write() = Some(hash);
		...
		// TODO Instead of this, set create_gap in the incoming BlockImportParams.
		// https://github.com/paritytech/polkadot-sdk/pull/9678/files#r2343104579
		operation.op.set_create_gap(if origin == BlockOrigin::ConsensusBroadcast {
			log::info!("XXX will create gap for {number}: false due to origin");
			...
			log::info!("XXX will create gap for {number}: create_gap={create_gap:?}");
			create_gap
		});
