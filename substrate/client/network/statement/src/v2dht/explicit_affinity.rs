...
//! Explicit topic affinity for the v2 DHT gossip path: tracks which topics this node cares about,
//! advertises a filter for them, and decides storage and forwarding from that affinity.
//!
