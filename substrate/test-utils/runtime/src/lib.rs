...
mod tests {
	...
	mod genesis_builder_tests {
		...
		fn default_config_as_json_works() {
			...
			let expected = r#"{"system":{},"babe":{"authorities":[],"epochConfig":null},"sassafras":{"authorities":[],"epochConfig":{"redundancy_factor":0,"attempts_number":0}},"substrateTest":{"authorities":[]},"balances":{"balances":[]}}"#;
