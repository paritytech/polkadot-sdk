	...
	B: backend::Backend<substrate_test_runtime::Block>,
{
	...
	assert_eq!(HeaderBackend::leaves(blockchain).unwrap(), vec![genesis_hash]);
	...
	assert_eq!(HeaderBackend::leaves(blockchain).unwrap(), vec![a1.hash()]);
	...
	assert_eq!(HeaderBackend::leaves(blockchain).unwrap(), vec![a2.hash()]);
	...
	assert_eq!(HeaderBackend::leaves(blockchain).unwrap(), vec![a3.hash()]);
	...
	assert_eq!(HeaderBackend::leaves(blockchain).unwrap(), vec![a4.hash()]);
	...
	assert_eq!(HeaderBackend::leaves(blockchain).unwrap(), vec![a5.hash()]);
	...
	assert_eq!(HeaderBackend::leaves(blockchain).unwrap(), vec![a5.hash(), b2.hash()]);
	...
	assert_eq!(HeaderBackend::leaves(blockchain).unwrap(), vec![a5.hash(), b3.hash()]);
	...
	assert_eq!(HeaderBackend::leaves(blockchain).unwrap(), vec![a5.hash(), b4.hash()]);
	...
	assert_eq!(HeaderBackend::leaves(blockchain).unwrap(), vec![a5.hash(), b4.hash(), c3.hash()]);
