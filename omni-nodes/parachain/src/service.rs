...
use crate::standards::{Hash, OpaqueBlock as Block};
...
pub(crate) mod parachain_service {
	...
	async fn start_node_impl(
		...
		if let Some(hwbench) = hwbench {
			...
			// Here you can check whether the hardware meets your chains' requirements. Putting a
			// link in there and swapping out the requirements for your own are probably a good
			// idea. The requirements for a para-chain are dictated by its relay-chain.
			// TODO: check hardware requirements
