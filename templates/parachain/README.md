...
Make sure to bring `zombienet` and the relaychain binaries (`polkadot`, `polkadot-prepare-worker`, `polkadot-execute-worker`) into `PATH`, so that they are available in the following steps.
