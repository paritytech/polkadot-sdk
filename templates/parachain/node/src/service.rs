...
// Local Runtime Types
<<<<<<< HEAD:cumulus/parachain-template/node/src/service.rs
use parachain_template_runtime::opaque::{Block, Hash};
||||||| 07e55006ad0:cumulus/parachain-template/node/src/service.rs
...
>>>>>>> origin/master:templates/parachain/node/src/service.rs
...
pub fn new_partial(config: &Configuration) -> Result<Service, sc_service::Error> {
	...
	let (client, backend, keystore_container, task_manager) = sc_service::new_full_parts_record_import::<Block, _>(
		config,
