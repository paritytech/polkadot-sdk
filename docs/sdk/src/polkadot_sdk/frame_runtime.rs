...
//! ## Introduction
//!
//! As described in [`wasm_meta_protocol`], at a high-level Substrate-based
...
//! between the two. See [`runtime_vs_smart_contract`] for more.
//!
...
//! [`wasm_meta_protocol`]). Notable examples are:
//!
