//! # Templates
//!
//! This document enumerates a non-exhaustive list of templates that one can use to get
//! started with polkadot-sdk.
//!
//! ## Internal
//!
...
//! ## OpenZeppelin
//!
//! In June 2023, OpenZeppelin was awarded a grant from the [Polkadot treasury](https://polkadot.polkassembly.io/treasury/406) for building a number of
//! Polkadot-sdk based templates. These templates are expected to be a great starting point for
//! developers.
//!
