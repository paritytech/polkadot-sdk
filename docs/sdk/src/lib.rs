...
//!
//! This crate is a *minimal*, *always-accurate* and low level source of truth about Polkadot-SDK. For more high level docs, please go to [docs.polkadot.com](https://docs.polkadot.com).
//!
//! ## Getting Started
//!
