...
//! [`frame_runtime`](crate::polkadot_sdk::frame_runtime)) that is capable of handling a simple crypto-currency.
//! This pallet will:
//!
...
//!
//! To get started, clone one of the templates mentioned in [`templates`](crate::polkadot_sdk::templates). We
...
//!   document ([`frame_origin`](crate::reference_docs::frame_origin)). For now, you should only know the
...
//! [`frame_runtime`](crate::polkadot_sdk::frame_runtime) that a runtime is a collection of pallets, expressed
...
//! [`trait_based_programming`](crate::reference_docs::trait_based_programming) before going further.
//!
