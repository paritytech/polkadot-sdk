...
//!
//! To get started, clone one of the templates mentioned in [`templates`]. We
...
//!   document ([`frame_origin`]). For now, you should only know the
...
//! [`frame_runtime`] that a runtime is a collection of pallets, expressed
...
//! [`trait_based_programming`] before going further.
//!
