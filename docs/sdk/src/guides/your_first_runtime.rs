...
//!
//! The good news is, in [`your_first_pallet`], we have already created a _test_
...
//! used.
//!
//! Recall that in test runtime in [`your_first_pallet`], we provided `type AccountId
...
//!
//! Recall from [`wasm_meta_protocol`] that every (real) runtime needs to
...
//! `chain-spec-builder`, see [`chain_spec_genesis`].
//!
//! ## Next Step
//!
//! See [`your_first_node`].
...
//! ## Further Reading
//!
//! 1. To learn more about signed extensions, see [`signed_extensions`].
