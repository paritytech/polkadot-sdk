...
//!
//! The good news is, in [`your_first_pallet`](crate::guides::your_first_pallet), we have already created a _test_
...
//! used.
//!
//! Recall that in test runtime in [`your_first_pallet`](crate::guides::your_first_pallet), we provided `type AccountId
...
//!
//! Recall from [`wasm_meta_protocol`](crate::reference_docs::wasm_meta_protocol) that every (real) runtime needs to
...
//! `chain-spec-builder`, see [`chain_spec_genesis`](crate::reference_docs::chain_spec_genesis).
//!
//! ## Next Step
//!
//! See [`your_first_node`](crate::guides::your_first_node).
//!
//! ## Further Reading
//!
//! 1. To learn more about signed extensions, see [`signed_extensions`](crate::reference_docs::signed_extensions).
...
// [`frame_runtime_types`]: crate::reference_docs::frame_runtime_types
// [`frame_runtime_upgrades_and_migrations`]: crate::reference_docs::frame_runtime_upgrades_and_migrations
// [`signed_extensions`]: crate::reference_docs::signed_extensions
// [`templates`]: crate::polkadot_sdk::templates
