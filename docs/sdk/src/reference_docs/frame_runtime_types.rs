...
//!
//! In this case, we will want to assert the existence of [`polkadot_sdk_frame::traits::IsSubType`], which is
...
//!
//! We leave it to the reader to further explore what [`polkadot_sdk_frame::traits::Hooks::integrity_test`] is,
//! and what [`core::any::TypeId`] is. Another way to assert this is using
//! [`polkadot_sdk_frame::traits::IsType`].
//!
//! ## Type Aliases
//!
