...
//! to cumbersome forkful upgrades to be the status quo in the blockchain ecosystem. In other words,
//! the entire node software is the specification of the blockchain's [`state transition
...
//!
//! This opaque-ness is the fundamental reason why Substrate-based chains can fork-less-ly
//! upgrade: because the node side code is kept oblivious to all of the details of the state
//! transition function. Therefore, the state transition function can freely upgrade without the
