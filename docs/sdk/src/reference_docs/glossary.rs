...
//! the entry points in [FRAME](polkadot_sdk_frame) pallets. They can be called by internal or
...
//! #### Pallet
//!
//! Similar to software modules in traditional programming, [FRAME](polkadot_sdk_frame) pallets in
