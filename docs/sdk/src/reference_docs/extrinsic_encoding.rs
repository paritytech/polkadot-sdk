...
//! ## compact_encoded_length
//!
//! This is a [SCALE compact encoded][frame::deps::codec::Compact] integer which is
...
//! ### from_address
//!
//! This is the [SCALE encoded][frame::deps::codec] address of the sender of the
...
//! ### signature
//!
//! This is the [SCALE encoded][frame::deps::codec] signature. The signature type is
...
//! ### signed_extensions_extra
//!
//! This is the concatenation of the [SCALE encoded][frame::deps::codec] bytes
...
//!
//! A call can be anything that implements [`Encode`][frame::deps::codec::Encode]. In
