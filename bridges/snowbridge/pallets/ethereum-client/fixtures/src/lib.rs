...
pub fn make_inbound_fixture<MaxNodeSize, MaxDepth>() -> EventFixture<Proof<MaxNodeSize, MaxDepth>>
where
	MaxNodeSize: Get<u32>,
	MaxDepth: Get<u32>,
{
	EventFixture {
        event: EventProof {
            ...
            proof: Proof {
                receipt_proof: snowbridge_verification_primitives::try_receipt_proof_from_vec::<
                    MaxNodeSize,
                    MaxDepth,
                >(vec![
