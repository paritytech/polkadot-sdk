...
// Based on `polkadot/zombienet-sdk-tests/build.rs`: it ensures that the subxt metadata
// `.scale` files required by the bridge tests are present, generating them from locally
// built runtime WASM blobs when the `zombie-metadata` feature is enabled.
