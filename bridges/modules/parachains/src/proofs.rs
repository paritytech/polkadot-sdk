...
use bp_runtime::{
	RawStorageProof, StorageProofChecker, StorageProofError, UnverifiedStorageProof,
...
impl<T: Config<I>, I: 'static> RawStorageProofAdapter<T, I> {
	...
	pub fn try_new_with_verified_storage_proof(
		...
		GrandpaPalletOf::<T, I>::verify_raw_storage_proof(relay_block_hash, storage_proof)
