...
use bp_runtime::{
	...
	RangeInclusiveExt, RawStorageProof, UnverifiedStorageProof, UnverifiedStorageProofParams,
};
use codec::Encode;
use frame_support::sp_runtime::StateVersion;
use sp_std::{ops::RangeInclusive, prelude::*};
use sp_trie::{
	trie_types::TrieDBMutBuilderV1, LayoutV0, LayoutV1, MemoryDB, TrieConfiguration,
...
/// Returns state trie root and nodes with prepared messages.
#[allow(clippy::too_many_arguments)]
pub fn prepare_messages_storage_proof_compact<BridgedChain: Chain, ThisChain: ChainWithMessages>(
	lane: LaneId,
	message_nonces: RangeInclusive<MessageNonce>,
	outbound_lane_data: Option<OutboundLaneData>,
	proof_params: UnverifiedStorageProofParams,
...
pub fn prepare_message_delivery_storage_proof_compact<
	BridgedChain: Chain,
