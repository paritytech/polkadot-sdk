...
// A subsystem that simulates a slow subsystem, processing messages at a rate of one per 100ms.
// We will use this to test the prioritization of messages in the overseer are processed before
// normal messages.
#[derive(Clone)]
