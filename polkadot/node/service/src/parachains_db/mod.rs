...
pub fn open_creating_rocksdb(
	...
	db_config.columns[columns::v6::COL_AVAILABILITY_DATA as usize].memory_budget =
		Some(cache_sizes.availability_data);
	db_config.columns[columns::v6::COL_AVAILABILITY_META as usize].memory_budget =
		Some(cache_sizes.availability_meta);
	db_config.columns[columns::v6::COL_APPROVAL_DATA as usize].memory_budget =
