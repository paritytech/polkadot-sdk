		...
		if block.with_state() {
			...
			)) = block.state_action
			{
				...
				let overrides = match self.context {
					DoppelGangerContext::Relaychain => get_overrides(),
					DoppelGangerContext::Parachain => get_overrides_para(1000_u32),
				};
			...
			if let DoppelGangerContext::Parachain = self.context {
				let output_buf = format!("0x{:?}", HexDisplay::from(&para_head)).into_bytes();
...
fn get_overrides() -> HashMap<Vec<u8>, Vec<u8>> {
	let mut overrides: HashMap<Vec<u8>, Vec<u8>> = HashMap::from([
		// <Pallet> < Item>
		...
		// Session Validators (alice, bob, charly, dave)
		(
			hex!("cec5070d609dd3497f72bde07fc96ba088dcde934c658227ee1dfafcd6e16903").into(),
			//(alice, bob)
			hex!("08be5ddb1579b72e84524fc29e78609e3caf42e85aa118ebfe0b0ad404b5bdd25ffe65717dad0447d715f660a0a58411de509b42e6efb8375f562f58a554d5860e").into()
			// hex!("").into()
		),
		//	Session QueuedKeys (alice, bob, charly, dave)
		(
			...
			//hex!("").into()
		),
		// Babe Authorities (alice, bob, charly, dave)
		(
			...
			//hex!("").into()
		),
		// Babe NextAuthorities (alice, bob, charly, dave)
		(
		...
		(
			...
			//hex!("").into()
		),
		// Staking ForceEra
		(
		...
		// paraScheduler.validatorGroup (one group of 4 valudators)
		(
		...
		(
			...
			//hex!("1000000000030000000200000001000000").into()
		),
		// paraShared.activeValidatorKeys (4 validators, alice, bob, charlie, dave)
		(
			...
			//hex!("").into()
		),
		// authorityDiscovery.keys (4 validators, alice, bob, charlie, dave)
		(
			hex!("2099d7f109d6e535fb000bba623fd4409f99a2ce711f3a31b2fc05604c93f179").into(),
			// (alice, bob)
			hex!("08d43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d8eaf04151687736326c9fea17e25fc5287613693c912909cb226aa4794f26a48").into()
			//hex!("").into()
		),
		// authorityDiscovery.nextKeys (4 validators, alice, bob, charlie, dave)
		(
...
fn get_overrides_para(_id: u32) -> HashMap<Vec<u8>, Vec<u8>> {
	// TODO: macth the id
