...
const ASSET_HUB_PARA_ID: ParaId = ParaId::new(500); // Asset Hub's para id is 1000 on both Kusama and Polkadot.
...
#[cfg(not(test))]
const HOLD_OFF_DURATION_DEFAULT_VALUE: Duration = Duration::from_millis(500);
#[cfg(test)]
