...
use polkadot_node_network_protocol::{
	...
	v1 as protocol_v1, v2 as protocol_v2, v3 as protocol_v3, v3_collation, v4_collation, PeerId,
};
...
// Helper function to send a collation v4 message to a list of peers.
// Messages are always sent via the main protocol, even the legacy protocol messages.
pub(crate) fn send_collation_message_v4(
	peers: Vec<PeerId>,
	message: WireMessage<v4_collation::CollationProtocol>,
	metrics: &Metrics,
	notification_sinks: &Arc<Mutex<HashMap<(PeerSet, PeerId), Box<dyn MessageSink>>>>,
) {
	send_message(
