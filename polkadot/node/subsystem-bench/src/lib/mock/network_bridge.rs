...
use polkadot_node_network_protocol::VersionedValidation;
						...
						match message {
							NetworkMessage::MessageFromPeer(peer_id, message) => match message {
								VersionedValidation::V3(
									...
									ctx.send_message(
										BitfieldDistributionMessage::NetworkBridgeUpdate(NetworkBridgeEvent::PeerMessage(peer_id, polkadot_node_network_protocol::VersionedValidation::V3(bitfield)))
									).await;
								},
								VersionedValidation::V3(
									...
									if self.approval_voting_parallel_enabled {
										ctx.send_message(
											ApprovalVotingParallelMessage::NetworkBridgeUpdate(NetworkBridgeEvent::PeerMessage(peer_id, polkadot_node_network_protocol::VersionedValidation::V3(msg)))
										).await;
									} else {
										ctx.send_message(
											ApprovalDistributionMessage::NetworkBridgeUpdate(NetworkBridgeEvent::PeerMessage(peer_id, polkadot_node_network_protocol::VersionedValidation::V3(msg)))
										).await;
									}
								}
								VersionedValidation::V3(
									...
									ctx.send_message(
										StatementDistributionMessage::NetworkBridgeUpdate(NetworkBridgeEvent::PeerMessage(peer_id, polkadot_node_network_protocol::VersionedValidation::V3(msg)))
									).await;
								},
							},
