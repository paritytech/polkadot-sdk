...
//! collators.
//!
//! Sibling of [`v4_resubmit_three_collators`] on the `block-bundling-v3` flavour: `velocity-6`
...
async fn v4_resubmit_bundling_rpo0() -> Result<(), anyhow::Error> {
	...
	assert_para_throughput(&relay_client, 100, [(ParaId::from(3000), 50..311)], []).await?;
