...
impl<T: frame_system::Config> pallet_mmr::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(x: u32, ) -> Weight {
		...
		// Minimum execution time: 9_532_141_000 picoseconds.
		Weight::from_parts(9_839_712_991, 0)
			.saturating_add(Weight::from_parts(0, 3608956))
			// Standard Error: 25_819
			.saturating_add(Weight::from_parts(168_250, 0).saturating_mul(x.into()))
