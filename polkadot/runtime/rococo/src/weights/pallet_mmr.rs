...
impl<T: frame_system::Config> pallet_mmr::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(x: u32, ) -> Weight {
		...
		// Minimum execution time: 9_461_973_000 picoseconds.
		Weight::from_parts(9_568_412_975, 0)
			.saturating_add(Weight::from_parts(0, 3608956))
			// Standard Error: 11_520
			.saturating_add(Weight::from_parts(125_126, 0).saturating_mul(x.into()))
