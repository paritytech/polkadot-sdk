...
impl<T: frame_system::Config> pallet_mmr::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(x: u32, ) -> Weight {
		...
		// Minimum execution time: 9_565_210_000 picoseconds.
		Weight::from_parts(9_617_733_899, 0)
			.saturating_add(Weight::from_parts(0, 3608956))
			// Standard Error: 24_763
			.saturating_add(Weight::from_parts(309_942, 0).saturating_mul(x.into()))
