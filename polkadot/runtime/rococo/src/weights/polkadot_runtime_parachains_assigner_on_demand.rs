...
// --output=./polkadot/runtime/rococo/src/weights/polkadot_runtime_parachains_assigner_on_demand.rs
...
impl<T: frame_system::Config> polkadot_runtime_parachains::assigner_on_demand::WeightInfo for WeightInfo<T> {
	...
	fn place_order_keep_alive(s: u32, ) -> Weight {
		...
		Weight::from_parts(35_094_566, 0)
	...
	fn place_order_allow_death(s: u32, ) -> Weight {
		...
		//  Measured:  `270 + s * (8 ±0)`
		//  Estimated: `3733 + s * (8 ±0)`
		// Minimum execution time: 48_252_000 picoseconds.
		Weight::from_parts(46_295_701, 0)
			.saturating_add(Weight::from_parts(0, 3733))
			// Standard Error: 179
			.saturating_add(Weight::from_parts(23_874, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
