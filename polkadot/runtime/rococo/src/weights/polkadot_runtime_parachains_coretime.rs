...
impl<T: frame_system::Config> polkadot_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `3116`
		//  Estimated: `6581`
		// Minimum execution time: 99_435_000 picoseconds.
		Weight::from_parts(103_177_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(12_896_671, 0)
			.saturating_add(Weight::from_parts(0, 3645))
			// Standard Error: 304
			.saturating_add(Weight::from_parts(11_086, 0).saturating_mul(s.into()))
