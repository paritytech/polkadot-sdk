...
// --output=./polkadot/runtime/rococo/src/weights/polkadot_runtime_parachains_coretime.rs
...
impl<T: frame_system::Config> polkadot_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `3052`
		//  Estimated: `6517`
		// Minimum execution time: 91_502_000 picoseconds.
		Weight::from_parts(93_847_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_215_750, 0)
			.saturating_add(Weight::from_parts(0, 3645))
			// Standard Error: 631
			.saturating_add(Weight::from_parts(8_612, 0).saturating_mul(s.into()))
