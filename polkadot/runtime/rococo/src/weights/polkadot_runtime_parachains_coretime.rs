...
impl<T: frame_system::Config> polkadot_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `3116`
		//  Estimated: `6581`
		// Minimum execution time: 98_025_000 picoseconds.
		Weight::from_parts(103_220_000, 0)
	...
	fn request_core_count() -> Weight {
		...
		Weight::from_parts(11_259_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_026_059, 0)
			.saturating_add(Weight::from_parts(0, 3645))
			// Standard Error: 357
			.saturating_add(Weight::from_parts(11_171, 0).saturating_mul(s.into()))
