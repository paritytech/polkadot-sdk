...
impl<T: frame_system::Config> polkadot_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `3116`
		//  Estimated: `6581`
		// Minimum execution time: 98_378_000 picoseconds.
		Weight::from_parts(101_166_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_021_698, 0)
			.saturating_add(Weight::from_parts(0, 3645))
			// Standard Error: 381
			.saturating_add(Weight::from_parts(10_831, 0).saturating_mul(s.into()))
