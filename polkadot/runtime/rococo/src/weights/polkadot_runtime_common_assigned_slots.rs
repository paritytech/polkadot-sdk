...
// --output=./polkadot/runtime/rococo/src/weights/polkadot_runtime_common_assigned_slots.rs
...
impl<T: frame_system::Config> polkadot_runtime_common::assigned_slots::WeightInfo for WeightInfo<T> {
	...
	fn assign_perm_parachain_slot() -> Weight {
		...
		//  Measured:  `730`
		//  Estimated: `4195`
		// Minimum execution time: 98_709_000 picoseconds.
		Weight::from_parts(104_017_000, 0)
