...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36283 + c * (16122 ±288) + h * (7594 ±341) + u * (20798 ±341)`
		// Minimum execution time: 366_260_000 picoseconds.
		Weight::from_parts(63_911_030, 0)
			.saturating_add(Weight::from_parts(0, 36283))
			// Standard Error: 318_850
			.saturating_add(Weight::from_parts(133_692_436, 0).saturating_mul(u.into()))
			// Standard Error: 318_850
			.saturating_add(Weight::from_parts(148_456_265, 0).saturating_mul(h.into()))
			// Standard Error: 528_373
			.saturating_add(Weight::from_parts(62_655_999, 0).saturating_mul(c.into()))
