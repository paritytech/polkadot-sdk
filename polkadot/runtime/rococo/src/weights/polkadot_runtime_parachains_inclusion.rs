...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 399_893_000 picoseconds.
		Weight::from_parts(65_670_794, 0)
			.saturating_add(Weight::from_parts(0, 36283))
			// Standard Error: 334_051
			.saturating_add(Weight::from_parts(145_956_982, 0).saturating_mul(u.into()))
			// Standard Error: 334_051
			.saturating_add(Weight::from_parts(159_301_124, 0).saturating_mul(h.into()))
			// Standard Error: 553_563
			.saturating_add(Weight::from_parts(66_135_389, 0).saturating_mul(c.into()))
