...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36283 + c * (16122 ±370) + h * (7594 ±0) + u * (20798 ±214)`
		// Minimum execution time: 389_066_000 picoseconds.
		Weight::from_parts(60_299_399, 0)
			.saturating_add(Weight::from_parts(0, 36283))
			// Standard Error: 396_547
			.saturating_add(Weight::from_parts(144_788_712, 0).saturating_mul(u.into()))
			// Standard Error: 396_547
			.saturating_add(Weight::from_parts(156_206_735, 0).saturating_mul(h.into()))
			// Standard Error: 657_126
			.saturating_add(Weight::from_parts(65_700_338, 0).saturating_mul(c.into()))
