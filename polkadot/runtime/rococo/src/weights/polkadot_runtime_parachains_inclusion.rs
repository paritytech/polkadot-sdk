...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36283 + c * (16122 ±0) + h * (7594 ±0) + u * (20798 ±0)`
		// Minimum execution time: 396_395_000 picoseconds.
		Weight::from_parts(64_756_223, 0)
			.saturating_add(Weight::from_parts(0, 36283))
			// Standard Error: 328_954
			.saturating_add(Weight::from_parts(144_376_533, 0).saturating_mul(u.into()))
			// Standard Error: 328_954
			.saturating_add(Weight::from_parts(158_621_495, 0).saturating_mul(h.into()))
			// Standard Error: 545_117
			.saturating_add(Weight::from_parts(69_751_168, 0).saturating_mul(c.into()))
