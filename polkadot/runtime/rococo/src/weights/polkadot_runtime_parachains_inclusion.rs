...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 396_768_000 picoseconds.
		Weight::from_parts(67_144_523, 0)
			.saturating_add(Weight::from_parts(0, 36283))
			// Standard Error: 395_253
			.saturating_add(Weight::from_parts(142_527_538, 0).saturating_mul(u.into()))
			// Standard Error: 395_253
			.saturating_add(Weight::from_parts(158_719_781, 0).saturating_mul(h.into()))
			// Standard Error: 654_982
			.saturating_add(Weight::from_parts(63_253_004, 0).saturating_mul(c.into()))
