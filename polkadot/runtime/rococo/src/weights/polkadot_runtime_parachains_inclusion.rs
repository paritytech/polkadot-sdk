...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36283 + c * (16122 ±272) + h * (7594 ±341) + u * (20798 ±147)`
		// Minimum execution time: 394_575_000 picoseconds.
		Weight::from_parts(84_028_134, 0)
			.saturating_add(Weight::from_parts(0, 36283))
			// Standard Error: 491_428
			.saturating_add(Weight::from_parts(136_551_193, 0).saturating_mul(u.into()))
			// Standard Error: 491_428
			.saturating_add(Weight::from_parts(145_141_922, 0).saturating_mul(h.into()))
			// Standard Error: 814_355
			.saturating_add(Weight::from_parts(62_691_943, 0).saturating_mul(c.into()))
