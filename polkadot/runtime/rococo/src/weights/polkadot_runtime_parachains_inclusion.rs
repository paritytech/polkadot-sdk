...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36283 + c * (16122 ±370) + h * (7594 ±341) + u * (20798 ±214)`
		// Minimum execution time: 387_249_000 picoseconds.
		Weight::from_parts(66_952_656, 0)
			.saturating_add(Weight::from_parts(0, 36283))
			// Standard Error: 404_534
			.saturating_add(Weight::from_parts(138_942_533, 0).saturating_mul(u.into()))
			// Standard Error: 404_534
			.saturating_add(Weight::from_parts(153_277_640, 0).saturating_mul(h.into()))
			// Standard Error: 670_362
			.saturating_add(Weight::from_parts(62_883_008, 0).saturating_mul(c.into()))
