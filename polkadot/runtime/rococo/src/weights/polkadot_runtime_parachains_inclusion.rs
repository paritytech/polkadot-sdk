...
// --output=./polkadot/runtime/rococo/src/weights/polkadot_runtime_parachains_inclusion.rs
...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `367 + c * (16114 ±0) + h * (92 ±0) + u * (32955 ±0)`
		//  Estimated: `36283 + c * (16122 ±272) + h * (7594 ±341) + u * (20798 ±341)`
		// Minimum execution time: 394_795_000 picoseconds.
		Weight::from_parts(75_656_179, 0)
			.saturating_add(Weight::from_parts(0, 36283))
			// Standard Error: 427_669
			.saturating_add(Weight::from_parts(142_557_768, 0).saturating_mul(u.into()))
			// Standard Error: 427_669
			.saturating_add(Weight::from_parts(156_275_385, 0).saturating_mul(h.into()))
			// Standard Error: 708_699
			.saturating_add(Weight::from_parts(59_555_092, 0).saturating_mul(c.into()))
