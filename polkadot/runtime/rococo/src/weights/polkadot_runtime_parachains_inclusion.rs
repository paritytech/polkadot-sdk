...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `36283 + c * (16122 ±272) + h * (7594 ±0) + u * (20798 ±147)`
		// Minimum execution time: 396_688_000 picoseconds.
		Weight::from_parts(73_139_190, 0)
			.saturating_add(Weight::from_parts(0, 36283))
			// Standard Error: 323_949
			.saturating_add(Weight::from_parts(141_550_370, 0).saturating_mul(u.into()))
			// Standard Error: 323_949
			.saturating_add(Weight::from_parts(155_611_434, 0).saturating_mul(h.into()))
			// Standard Error: 536_822
			.saturating_add(Weight::from_parts(61_874_911, 0).saturating_mul(c.into()))
