...
//! to.
//!
//! `CoreDescriptor` contains pointers to the beginning and the end of a list of schedules, together
...
/// Fraction expressed as a numerator with an assumed denominator of 57,600.
