...
lazy_static::lazy_static! {
	pub static ref TRACKS_DATA: [pallet_referenda::Track<u16, Balance, BlockNumber>; 15] = {
		[
			...
			pallet_referenda::Track {
				id: 1,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"whitelisted_caller".to_vec()),
					max_deciding: 100,
			...
			pallet_referenda::Track {
				id: 10,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"staking_admin".to_vec()),
					max_deciding: 10,
			...
			pallet_referenda::Track {
				id: 11,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"treasurer".to_vec()),
					max_deciding: 10,
			...
			pallet_referenda::Track {
				id: 12,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"lease_admin".to_vec()),
					max_deciding: 10,
					decision_deposit: 5 * GRAND,
					prepare_period: 8 * MINUTES,
					decision_period: 20 * MINUTES,
			...
			pallet_referenda::Track {
				id: 13,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"fellowship_admin".to_vec()),
					max_deciding: 10,
					decision_deposit: 5 * GRAND,
					prepare_period: 8 * MINUTES,
					decision_period: 20 * MINUTES,
			...
			pallet_referenda::Track {
				id: 14,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"general_admin".to_vec()),
					max_deciding: 10,
					decision_deposit: 5 * GRAND,
					prepare_period: 8 * MINUTES,
					decision_period: 20 * MINUTES,
			...
			pallet_referenda::Track {
				id: 15,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"auction_admin".to_vec()),
					max_deciding: 10,
					decision_deposit: 5 * GRAND,
					prepare_period: 8 * MINUTES,
					decision_period: 20 * MINUTES,
			...
			pallet_referenda::Track {
				id: 20,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"referendum_canceller".to_vec()),
					max_deciding: 1_000,
					decision_deposit: 10 * GRAND,
					prepare_period: 8 * MINUTES,
			...
			pallet_referenda::Track {
				id: 21,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"referendum_killer".to_vec()),
					max_deciding: 1_000,
			...
			pallet_referenda::Track {
				id: 30,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"small_tipper".to_vec()),
					max_deciding: 200,
			...
			pallet_referenda::Track {
				id: 31,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"big_tipper".to_vec()),
					max_deciding: 100,
			...
			pallet_referenda::Track {
				id: 32,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"small_spender".to_vec()),
					max_deciding: 50,
			...
			pallet_referenda::Track {
				id: 33,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"medium_spender".to_vec()),
					max_deciding: 50,
			...
			pallet_referenda::Track {
				id: 34,
				info: pallet_referenda::TrackInfo {
					name: BoundedVec::truncate_from(b"big_spender".to_vec()),
					max_deciding: 50,
