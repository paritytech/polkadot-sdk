...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(5_739_000, 0)
			...
			.saturating_add(Weight::from_parts(3_612_033, 0).saturating_mul(c.into()))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(5_704_000, 0)
			...
			.saturating_add(Weight::from_parts(3_852_750, 0).saturating_mul(c.into()))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(5_613_000, 0)
			...
			.saturating_add(Weight::from_parts(3_626_548, 0).saturating_mul(c.into()))
	}
