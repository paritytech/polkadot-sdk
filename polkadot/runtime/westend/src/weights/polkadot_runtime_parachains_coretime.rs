...
impl<T: frame_system::Config> polkadot_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	// TODO: hand-written placeholder until regenerated by benchmarking CI (`/cmd bench`),
	// modeled on `place_order_with_credits` from `polkadot_runtime_parachains_on_demand.rs`.
