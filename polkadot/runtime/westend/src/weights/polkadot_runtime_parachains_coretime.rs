...
//! HOSTNAME: `ca36f791d545`, CPU: `Intel(R) Xeon(R) CPU @ 2.60GHz`
...
impl<T: frame_system::Config> polkadot_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `3049`
		//  Estimated: `6514`
		// Minimum execution time: 88_647_000 picoseconds.
		Weight::from_parts(96_085_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_959_863, 0)
			.saturating_add(Weight::from_parts(0, 1538))
			// Standard Error: 57
			.saturating_add(Weight::from_parts(8_932, 0).saturating_mul(s.into()))
	...
	fn queue_on_demand_batch(s: u32, ) -> Weight {
		...
		Weight::from_parts(144_956_852, 0)
			.saturating_add(Weight::from_parts(0, 81641))
			// Standard Error: 1_279
			.saturating_add(Weight::from_parts(16_204, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
