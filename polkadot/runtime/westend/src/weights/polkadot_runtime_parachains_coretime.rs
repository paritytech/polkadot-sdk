...
//! HOSTNAME: `e0b6a9f2db9f`, CPU: `Intel(R) Xeon(R) CPU @ 2.60GHz`
...
impl<T: frame_system::Config> polkadot_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		Weight::from_parts(93_368_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_703_123, 0)
			.saturating_add(Weight::from_parts(0, 1538))
			// Standard Error: 43
			.saturating_add(Weight::from_parts(9_616, 0).saturating_mul(s.into()))
