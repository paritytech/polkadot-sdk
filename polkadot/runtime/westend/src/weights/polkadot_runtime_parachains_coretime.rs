...
impl<T: frame_system::Config> polkadot_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `3083`
		//  Estimated: `6548`
		// Minimum execution time: 98_907_000 picoseconds.
		Weight::from_parts(102_860_000, 0)
	...
	fn request_core_count() -> Weight {
		...
		Weight::from_parts(11_548_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_711_261, 0)
			.saturating_add(Weight::from_parts(0, 3612))
			// Standard Error: 473
			.saturating_add(Weight::from_parts(13_957, 0).saturating_mul(s.into()))
