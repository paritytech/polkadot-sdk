...
impl<T: frame_system::Config> polkadot_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `3083`
		//  Estimated: `6548`
		// Minimum execution time: 97_809_000 picoseconds.
		Weight::from_parts(100_848_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_488_534, 0)
			.saturating_add(Weight::from_parts(0, 3612))
			// Standard Error: 591
			.saturating_add(Weight::from_parts(10_926, 0).saturating_mul(s.into()))
