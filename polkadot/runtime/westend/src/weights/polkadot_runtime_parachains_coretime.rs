...
impl<T: frame_system::Config> polkadot_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `3083`
		//  Estimated: `6548`
		// Minimum execution time: 98_099_000 picoseconds.
		Weight::from_parts(101_616_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_379_087, 0)
			.saturating_add(Weight::from_parts(0, 3612))
			// Standard Error: 457
			.saturating_add(Weight::from_parts(14_623, 0).saturating_mul(s.into()))
