...
impl<T: frame_system::Config> polkadot_runtime_parachains::coretime::WeightInfo for WeightInfo<T> {
	...
	fn request_revenue_at() -> Weight {
		...
		//  Measured:  `3083`
		//  Estimated: `6548`
		// Minimum execution time: 95_912_000 picoseconds.
		Weight::from_parts(98_077_000, 0)
	...
	fn assign_core(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_247_809, 0)
			.saturating_add(Weight::from_parts(0, 3612))
			// Standard Error: 301
			.saturating_add(Weight::from_parts(9_196, 0).saturating_mul(s.into()))
