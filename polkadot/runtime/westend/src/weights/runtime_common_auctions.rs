...
// --output=./polkadot/runtime/westend/src/weights/runtime_common_auctions.rs
...
impl<T: frame_system::Config> runtime_common::auctions::WeightInfo for WeightInfo<T> {
	...
	fn bid() -> Weight {
		...
		Weight::from_parts(86_503_000, 0)
	...
	/// Proof: `Slots::Leases` (`max_values`: None, `max_size`: None, mode: `Measured`)
	/// Storage: `Slots::ReservedAmounts` (r:7 w:7)
	/// Proof: `Slots::ReservedAmounts` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	fn on_initialize() -> Weight {
		...
		//  Measured:  `6947155`
		//  Estimated: `15822990`
		// Minimum execution time: 7_361_449_000 picoseconds.
		Weight::from_parts(7_447_578_000, 0)
			.saturating_add(Weight::from_parts(0, 15822990))
			.saturating_add(T::DbWeight::get().reads(3694))
			.saturating_add(T::DbWeight::get().writes(3689))
	}
	/// Storage: `Auctions::ReservedAmounts` (r:37 w:36)
	/// Proof: `Auctions::ReservedAmounts` (`max_values`: None, `max_size`: Some(60), added: 2535, mode: `MaxEncodedLen`)
	/// Storage: `System::Account` (r:36 w:36)
	...
	fn cancel_auction() -> Weight {
		...
		//  Measured:  `177903`
		//  Estimated: `15822990`
		// Minimum execution time: 5_611_898_000 picoseconds.
		Weight::from_parts(5_762_422_000, 0)
			.saturating_add(Weight::from_parts(0, 15822990))
