...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 1_121_270_000 picoseconds.
		Weight::from_parts(188_439_129, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 1_364_720
			.saturating_add(Weight::from_parts(471_054_841, 0).saturating_mul(u.into()))
			// Standard Error: 1_364_720
			.saturating_add(Weight::from_parts(552_405_702, 0).saturating_mul(h.into()))
			// Standard Error: 2_261_505
			.saturating_add(Weight::from_parts(20_063_503, 0).saturating_mul(c.into()))
