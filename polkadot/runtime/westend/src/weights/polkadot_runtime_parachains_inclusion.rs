...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 1_225_413_000 picoseconds.
		Weight::from_parts(167_638_437, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 1_993_462
			.saturating_add(Weight::from_parts(538_172_250, 0).saturating_mul(u.into()))
			// Standard Error: 1_993_462
			.saturating_add(Weight::from_parts(547_380_157, 0).saturating_mul(h.into()))
			// Standard Error: 3_303_406
			.saturating_add(Weight::from_parts(27_040_117, 0).saturating_mul(c.into()))
