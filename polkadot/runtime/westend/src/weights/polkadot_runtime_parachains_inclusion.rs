...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `134587 + c * (25419 ±1_284) + h * (29985 ±1_360) + u * (82828 ±1_360)`
		// Minimum execution time: 1_097_423_000 picoseconds.
		Weight::from_parts(173_599_173, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 1_405_340
			.saturating_add(Weight::from_parts(458_240_434, 0).saturating_mul(u.into()))
			// Standard Error: 1_405_340
			.saturating_add(Weight::from_parts(534_772_002, 0).saturating_mul(h.into()))
			// Standard Error: 2_328_816
			.saturating_add(Weight::from_parts(30_716_882, 0).saturating_mul(c.into()))
