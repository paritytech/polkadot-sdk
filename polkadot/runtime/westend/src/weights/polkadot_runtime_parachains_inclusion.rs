...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 1_071_915_000 picoseconds.
		Weight::from_parts(155_530_732, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 1_538_061
			.saturating_add(Weight::from_parts(473_185_387, 0).saturating_mul(u.into()))
			// Standard Error: 1_538_061
			.saturating_add(Weight::from_parts(547_202_472, 0).saturating_mul(h.into()))
			// Standard Error: 2_548_751
			.saturating_add(Weight::from_parts(56_889_808, 0).saturating_mul(c.into()))
