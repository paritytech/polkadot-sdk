...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 1_183_871_000 picoseconds.
		Weight::from_parts(167_680_167, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 1_340_818
			.saturating_add(Weight::from_parts(511_687_636, 0).saturating_mul(u.into()))
			// Standard Error: 1_340_818
			.saturating_add(Weight::from_parts(526_585_800, 0).saturating_mul(h.into()))
			// Standard Error: 2_221_895
			.saturating_add(Weight::from_parts(31_748_560, 0).saturating_mul(c.into()))
