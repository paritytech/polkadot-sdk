...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 1_144_495_000 picoseconds.
		Weight::from_parts(186_580_605, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 1_467_832
			.saturating_add(Weight::from_parts(477_665_027, 0).saturating_mul(u.into()))
			// Standard Error: 1_467_832
			.saturating_add(Weight::from_parts(550_755_762, 0).saturating_mul(h.into()))
			// Standard Error: 2_432_373
			.saturating_add(Weight::from_parts(25_939_693, 0).saturating_mul(c.into()))
