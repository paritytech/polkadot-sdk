...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Estimated: `134587 + c * (25419 ±939) + h * (29985 ±1_360) + u * (82828 ±1_360)`
		// Minimum execution time: 1_084_477_000 picoseconds.
		Weight::from_parts(168_361_419, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 1_332_948
			.saturating_add(Weight::from_parts(459_510_383, 0).saturating_mul(u.into()))
			// Standard Error: 1_332_948
			.saturating_add(Weight::from_parts(541_339_984, 0).saturating_mul(h.into()))
			// Standard Error: 2_208_854
			.saturating_add(Weight::from_parts(27_701_616, 0).saturating_mul(c.into()))
