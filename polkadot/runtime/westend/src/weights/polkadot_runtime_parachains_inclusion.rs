...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	/// The range of component `u` is `[0, 5]`.
	/// The range of component `h` is `[0, 5]`.
	/// The range of component `c` is `[0, 1]`.
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `132728 + c * (15992 ±0) + h * (78 ±0)`
		//  Estimated: `134587 + c * (39284 ±4_418) + h * (8874 ±671) + u * (18276 ±671)`
		// Minimum execution time: 2_364_060_000 picoseconds.
		Weight::from_parts(2_420_461_000, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 4_749_751
			.saturating_add(Weight::from_parts(284_476_935, 0).saturating_mul(u.into()))
			// Standard Error: 4_749_751
			.saturating_add(Weight::from_parts(399_328_035, 0).saturating_mul(h.into()))
			...
			.saturating_add(Weight::from_parts(0, 39284).saturating_mul(c.into()))
			.saturating_add(Weight::from_parts(0, 8874).saturating_mul(h.into()))
			.saturating_add(Weight::from_parts(0, 18276).saturating_mul(u.into()))
	}
}
