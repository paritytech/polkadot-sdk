...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 1_112_899_000 picoseconds.
		Weight::from_parts(179_496_826, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 1_323_871
			.saturating_add(Weight::from_parts(464_649_744, 0).saturating_mul(u.into()))
			// Standard Error: 1_323_871
			.saturating_add(Weight::from_parts(540_664_599, 0).saturating_mul(h.into()))
			// Standard Error: 2_193_813
			.saturating_add(Weight::from_parts(26_730_179, 0).saturating_mul(c.into()))
