...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `132737 + c * (15992 ±0) + h * (76 ±0)`
		//  Estimated: `134587 + c * (73970 ±1_606) + h * (4565 ±237) + u * (5234 ±237)`
		// Minimum execution time: 5_078_088_000 picoseconds.
		Weight::from_parts(5_285_606_000, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 5_002_420
			.saturating_add(Weight::from_parts(284_100_612, 0).saturating_mul(u.into()))
			// Standard Error: 5_002_420
			.saturating_add(Weight::from_parts(380_587_881, 0).saturating_mul(h.into()))
			...
			.saturating_add(Weight::from_parts(0, 73970).saturating_mul(c.into()))
			.saturating_add(Weight::from_parts(0, 4565).saturating_mul(h.into()))
			.saturating_add(Weight::from_parts(0, 5234).saturating_mul(u.into()))
	}
}
