...
impl<T: frame_system::Config> polkadot_runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		// Minimum execution time: 1_068_364_000 picoseconds.
		Weight::from_parts(180_680_303, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 1_190_875
			.saturating_add(Weight::from_parts(445_706_202, 0).saturating_mul(u.into()))
			// Standard Error: 1_190_875
			.saturating_add(Weight::from_parts(514_718_536, 0).saturating_mul(h.into()))
			// Standard Error: 1_973_422
			.saturating_add(Weight::from_parts(23_730_292, 0).saturating_mul(c.into()))
