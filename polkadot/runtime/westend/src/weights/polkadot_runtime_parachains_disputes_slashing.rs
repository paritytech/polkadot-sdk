...
//! HOSTNAME: `85d58f38cb4a`, CPU: `Intel(R) Xeon(R) CPU @ 2.60GHz`
...
impl<T: frame_system::Config> polkadot_runtime_parachains::disputes::slashing::WeightInfo for WeightInfo<T> {
	...
	fn report_dispute_lost_unsigned(n: u32, ) -> Weight {
		...
		// Minimum execution time: 106_156_000 picoseconds.
		Weight::from_parts(156_663_785, 0)
			.saturating_add(Weight::from_parts(0, 5588))
			// Standard Error: 5_693
			.saturating_add(Weight::from_parts(278_588, 0).saturating_mul(n.into()))
