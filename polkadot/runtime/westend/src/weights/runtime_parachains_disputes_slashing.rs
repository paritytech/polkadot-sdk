...
// --output=./polkadot/runtime/westend/src/weights/runtime_parachains_disputes_slashing.rs
...
impl<T: frame_system::Config> runtime_parachains::disputes::slashing::WeightInfo for WeightInfo<T> {
	...
	fn report_dispute_lost(n: u32, ) -> Weight {
		...
		//  Measured:  `4816 + n * (255 ±0)`
		//  Estimated: `8124 + n * (258 ±0)`
		// Minimum execution time: 79_815_000 picoseconds.
		Weight::from_parts(127_759_178, 0)
			.saturating_add(Weight::from_parts(0, 8124))
			// Standard Error: 5_772
			.saturating_add(Weight::from_parts(374_338, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(16))
			.saturating_add(T::DbWeight::get().writes(9))
			.saturating_add(Weight::from_parts(0, 258).saturating_mul(n.into()))
	}
}
