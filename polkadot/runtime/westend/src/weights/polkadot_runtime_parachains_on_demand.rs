...
impl<T: frame_system::Config> polkadot_runtime_parachains::on_demand::WeightInfo for WeightInfo<T> {
	...
	fn place_order_keep_alive(s: u32, ) -> Weight {
		...
		// Minimum execution time: 47_796_000 picoseconds.
		Weight::from_parts(37_241_976, 0)
			.saturating_add(Weight::from_parts(0, 3733))
			// Standard Error: 177
			.saturating_add(Weight::from_parts(22_783, 0).saturating_mul(s.into()))
	...
	fn place_order_allow_death(s: u32, ) -> Weight {
		...
		Weight::from_parts(38_803_572, 0)
			.saturating_add(Weight::from_parts(0, 3733))
			// Standard Error: 180
			.saturating_add(Weight::from_parts(22_676, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
