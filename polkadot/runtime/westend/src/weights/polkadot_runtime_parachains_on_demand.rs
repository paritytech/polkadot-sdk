...
impl<T: frame_system::Config> polkadot_runtime_parachains::on_demand::WeightInfo for WeightInfo<T> {
	...
	fn place_order_keep_alive(s: u32, ) -> Weight {
		...
		Weight::from_parts(35_794_798, 0)
			.saturating_add(Weight::from_parts(0, 3733))
			// Standard Error: 202
			.saturating_add(Weight::from_parts(29_531, 0).saturating_mul(s.into()))
	...
	fn place_order_allow_death(s: u32, ) -> Weight {
		...
		//  Measured:  `270 + s * (8 ±0)`
		//  Estimated: `3733 + s * (8 ±0)`
		// Minimum execution time: 48_329_000 picoseconds.
		Weight::from_parts(37_572_777, 0)
			.saturating_add(Weight::from_parts(0, 3733))
			// Standard Error: 267
			.saturating_add(Weight::from_parts(28_677, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
	...
	fn place_order_with_credits(s: u32, ) -> Weight {
		...
		Weight::from_parts(15_600_266, 0)
			.saturating_add(Weight::from_parts(0, 3767))
			// Standard Error: 185
			.saturating_add(Weight::from_parts(27_205, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(4))
			.saturating_add(Weight::from_parts(0, 8).saturating_mul(s.into()))
	}
