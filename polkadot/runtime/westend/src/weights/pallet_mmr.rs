...
impl<T: frame_system::Config> pallet_mmr::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize(x: u32, ) -> Weight {
		...
		// Minimum execution time: 9_478_221_000 picoseconds.
		Weight::from_parts(9_552_487_287, 0)
			.saturating_add(Weight::from_parts(0, 3608924))
			// Standard Error: 62_823
			.saturating_add(Weight::from_parts(497_862, 0).saturating_mul(x.into()))
