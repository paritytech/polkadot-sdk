...
impl<T: frame_system::Config> pallet_offences::WeightInfo for WeightInfo<T> {
	...
	fn report_offence_grandpa(n: u32, ) -> Weight {
		...
		//  Measured:  `987`
		//  Estimated: `4452`
		// Minimum execution time: 59_165_000 picoseconds.
		Weight::from_parts(62_835_845, 0)
			.saturating_add(Weight::from_parts(0, 4452))
			// Standard Error: 9_774
			.saturating_add(Weight::from_parts(552_324, 0).saturating_mul(n.into()))
	...
	fn report_offence_babe(n: u32, ) -> Weight {
		...
		//  Measured:  `987`
		//  Estimated: `4452`
		// Minimum execution time: 59_016_000 picoseconds.
		Weight::from_parts(61_933_705, 0)
			.saturating_add(Weight::from_parts(0, 4452))
			// Standard Error: 7_770
			.saturating_add(Weight::from_parts(570_989, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(11))
			.saturating_add(T::DbWeight::get().writes(6))
	}
}
