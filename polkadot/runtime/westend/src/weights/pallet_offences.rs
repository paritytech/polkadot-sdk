...
impl<T: frame_system::Config> pallet_offences::WeightInfo for WeightInfo<T> {
	...
	fn report_offence_grandpa(n: u32, ) -> Weight {
		...
		// Minimum execution time: 66_832_000 picoseconds.
		Weight::from_parts(71_692_470, 0)
			.saturating_add(Weight::from_parts(0, 4439))
			// Standard Error: 26_210
			.saturating_add(Weight::from_parts(12_712_766, 0).saturating_mul(n.into()))
	...
	fn report_offence_babe(n: u32, ) -> Weight {
		...
		//  Measured:  `989`
		//  Estimated: `4439 + n * (2551 ±0)`
		// Minimum execution time: 67_629_000 picoseconds.
		Weight::from_parts(72_646_703, 0)
			.saturating_add(Weight::from_parts(0, 4439))
			// Standard Error: 24_180
			.saturating_add(Weight::from_parts(12_495_904, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(12))
			.saturating_add(T::DbWeight::get().reads((3_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes(7))
			.saturating_add(T::DbWeight::get().writes((3_u64).saturating_mul(n.into())))
