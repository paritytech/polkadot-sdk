...
// --output=./polkadot/runtime/westend/src/weights/runtime_parachains_inclusion.rs
...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn receive_upward_messages(i: u32, ) -> Weight {
		...
		//  Measured:  `131297`
		//  Estimated: `134587`
		// Minimum execution time: 211_984_000 picoseconds.
		Weight::from_parts(212_523_000, 0)
			.saturating_add(Weight::from_parts(0, 134587))
			// Standard Error: 40_236
			.saturating_add(Weight::from_parts(193_935_282, 0).saturating_mul(i.into()))
