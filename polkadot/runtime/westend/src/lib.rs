...
sp_api::impl_runtime_apis! {
	...
	impl mmr::MmrApi<Block, Hash, BlockNumber> for Runtime {
		...
		) -> Result<(Vec<mmr::EncodableOpaqueLeaf>, mmr::Proof<(u64, mmr::Hash)>), mmr::Error> {
		...
		fn verify_proof(leaves: Vec<mmr::EncodableOpaqueLeaf>, proof: mmr::Proof<(u64, mmr::Hash)>)
			-> Result<(), mmr::Error>
		{
