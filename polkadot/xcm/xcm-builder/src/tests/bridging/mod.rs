...
use xcm::{AlwaysLatest, DetermineVersion, Version};
use xcm_executor::{
...
impl<D: DispatchBlob> DetermineVersion for TestBridge<D> {
	fn determine_version_for(dest: &MultiLocation, handle_unknown: bool) -> Option<Version> {
