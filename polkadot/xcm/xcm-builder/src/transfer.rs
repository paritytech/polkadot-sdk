...
use frame_support::traits::{tokens::PaymentStatus, Get, tokens::Transfer};
use sp_runtime::traits::TryConvert;
use xcm::{latest::Error, opaque::lts::Weight, prelude::*};
use xcm_builder::LocatableAssetId;
use xcm_executor::traits::{QueryHandler, QueryResponseStatus};
use frame_support::tokens::transfer::Transfer;


/// Abstraction to get a fee from the remote chain.
///
/// Todo!(Remove this brittle trait and add the fee as method parameter in the transfer trait)
