...
use crate::{v3::MultiLocation as OldMultiLocation, VersionedMultiLocation};
use core::{
...
impl MultiLocation {
	...
	pub const fn into_versioned(self) -> VersionedMultiLocation {
		VersionedMultiLocation::V4(self)
	}
...
xcm_procedural::impl_conversion_functions_for_multilocation_v4!();
...
mod tests {
	...
	fn conversion_from_other_types_works() {
		...
		assert_eq!(
			v3::MultiLocation::from(v3::Junctions::Here).try_into(),
			Ok(MultiLocation::here())
		);
		assert_eq!(v3::MultiLocation::from(v3::Parent).try_into(), Ok(MultiLocation::parent()));
		assert_eq!(
			v3::MultiLocation::from((v3::Parent, v3::Parent, v3::Junction::GeneralIndex(42u128),))
				.try_into(),
