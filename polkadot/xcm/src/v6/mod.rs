...
pub mod prelude {
	mod contents {
		pub use super::super::{instructions, XcmWeightInfo, VERSION as XCM_VERSION};
		pub use crate::{
			v5::prelude::{
...
#[derive(
	Educe, Encode, Decode, TypeInfo, xcm_procedural::XcmWeightInfoTrait, xcm_procedural::Builder,
)]
