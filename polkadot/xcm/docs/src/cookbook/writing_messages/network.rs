...
/// Remember tokens are represented using decimals, not floating-point numbers,
/// that's why this is one token even though it has 10 following zeroes.
/// The number of decimals can be defined per token on FRAME.
