...
- run the latest binary from our [releases](https://github.com/paritytech/polkadot-sdk/releases) page (make sure to also download all the `worker` binaries and put them in the same directory as `polkadot`), or
