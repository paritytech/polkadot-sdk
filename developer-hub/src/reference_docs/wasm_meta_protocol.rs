...
//! ## Client vs. Runtime
//!
//! A common question is: what components of the system end up being part of the client, and what
...
//! value (eg. if it is a number of a vector). Contrary, the runtime knows both the meaning of their
